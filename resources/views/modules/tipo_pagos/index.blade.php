                ...
                @forelse ($tipo_pagos as $tipo_pago)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4 text-right flex gap-2.5">
                            <a href="{{ route('tipo_pagos.edit', $tipo_pago) }}" class="text-white dark:text-gray-500 hover:underline mr-4">
                                <flux:icon name="pencil-square" />
                            </a>
                            <a href="{{ route('tipo_pagos.destroy', $tipo_pago) }}" class="text-white dark:text-gray-500 hover:underline mr-4">
